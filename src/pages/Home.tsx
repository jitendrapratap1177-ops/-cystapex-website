...
export default function Home() {
  return (
    <>
<header className="relative pt-72 pb-56 px-8 overflow-hidden">
<div className="max-w-8xl mx-auto grid lg:grid-cols-2 gap-32 items-center">
<div className="flex flex-col gap-16">
<div>
<span className="inline-block px-4 py-1.5 bg-golden text-base-dark text-[10px] font-black uppercase tracking-[0.2em] rounded mb-10">Digital Growth Agency</span>
<h1 className="text-6xl md:text-[84px] font-extrabold leading-[1.05] tracking-tight text-white mb-14">
...
<Link to="/contact" className="bg-gradient-primary px-12 py-6 rounded-lg text-lg font-bold text-white shadow-2xl shadow-primary/40 hover:scale-[1.02] transition-transform inline-block">
                    Grow Yourself
                </Link>
</div>
</div>
<div className="relative lg:pl-24">
<div className="relative z-10 grid grid-cols-2 gap-8 translate-x-12">
<div className="bg-card-dark p-10 rounded-2xl border border-white/10 shadow-2xl translate-y-12">
<div className="flex items-center justify-between mb-6">
<span className="material-symbols-outlined text-sea-green scale-110">trending_up</span>
<span className="text-[11px] text-sea-green font-black bg-sea-green/10 px-3 py-1 rounded-full">+87%</span>
</div>
<div className="text-4xl font-extrabold text-white">42.8k</div>
<div className="text-[10px] text-slate-500 uppercase font-black tracking-widest mt-2">Monthly Traffic</div>
</div>
<div className="bg-card-dark p-10 rounded-2xl border border-white/10 shadow-2xl -translate-y-8">
<div className="flex items-center justify-between mb-6">
<span className="material-symbols-outlined text-primary scale-110">groups</span>
<span className="text-[11px] text-primary font-black bg-primary/10 px-3 py-1 rounded-full">Live</span>
</div>
<div className="text-4xl font-extrabold text-white">340+</div>
<div className="text-[10px] text-slate-500 uppercase font-black tracking-widest mt-2">Qualified Leads</div>
</div>
<div className="col-span-2 bg-card-dark p-12 rounded-2xl border border-white/10 shadow-2xl mt-4">
<div className="flex items-center justify-between mb-8">
<div className="text-base font-bold text-white">Conversion Performance</div>
<span className="material-symbols-outlined text-slate-600">more_horiz</span>
</div>
<div className="flex items-end gap-3 h-40">
<div className="flex-1 bg-primary/20 rounded-t-lg h-16"></div>
<div className="flex-1 bg-primary/40 rounded-t-lg h-24"></div>
<div className="flex-1 bg-primary/60 rounded-t-lg h-36"></div>
<div className="flex-1 bg-primary rounded-t-lg h-40"></div>
<div className="flex-1 bg-sea-blue rounded-t-lg h-32"></div>
<div className="flex-1 bg-sea-blue/60 rounded-t-lg h-20"></div>
</div>
</div>
</div>
<div className="absolute -top-20 -right-20 w-[500px] h-[500px] bg-primary/20 blur-[120px] rounded-full"></div>
<div className="absolute -bottom-20 -left-20 w-[400px] h-[400px] bg-sea-blue/20 blur-[120px] rounded-full"></div>
</div>
</div>
</header>
<section className="py-40 px-8 border-y border-white/5 bg-card-dark/30">
<div className="max-w-8xl mx-auto flex flex-wrap justify-between items-center gap-16 lg:gap-32">
<div className="flex-1 min-w-[200px] flex flex-col items-center">
<div className="text-5xl font-black text-sea-green leading-none">50+</div>
<div className="text-[11px] font-black text-slate-500 uppercase tracking-[0.3em] mt-4">Active Brands</div>
</div>
<div className="flex-1 min-w-[200px] flex flex-col items-center">
<div className="text-5xl font-black text-golden leading-none">3x</div>
<div className="text-[11px] font-black text-slate-500 uppercase tracking-[0.3em] mt-4">Average ROI</div>
</div>
<div className="flex-1 min-w-[200px] flex flex-col items-center">
<div className="text-5xl font-black text-sea-blue leading-none">200+</div>
<div className="text-[11px] font-black text-slate-500 uppercase tracking-[0.3em] mt-4">Campaigns Run</div>
</div>
<div className="flex-1 min-w-[200px] flex flex-col items-center">
<div className="text-5xl font-black text-primary leading-none">98%</div>
<div className="text-[11px] font-black text-slate-500 uppercase tracking-[0.3em] mt-4">Retention Rate</div>
</div>
</div>
</section>
<section className="py-40 px-8 bg-alt-dark">
...
<section className="py-40 px-8 relative dot-grid overflow-hidden">
<div className="max-w-8xl mx-auto">
<div className="text-center mb-36">
<h2 className="text-5xl md:text-6xl font-extrabold text-white mb-6">The Apex Protocol</h2>
<p className="text-slate-400 text-lg">Our systematic 3-step approach to scaling your brand to the summit.</p>
</div>
<div className="relative flex flex-col md:flex-row gap-24 lg:gap-48 items-center justify-between px-12">
...
<section className="py-40 px-8 bg-base-dark">
<div className="max-w-8xl mx-auto">
<div className="text-center mb-32">
<h2 className="text-5xl md:text-6xl font-extrabold text-white mb-6">Trusted by Market Leaders</h2>
<p className="text-slate-400 text-lg">Real results from brands that demanded more than just average marketing.</p>
</div>
<div className="grid md:grid-cols-3 gap-16">
<div className="p-[1px] rounded-2xl bg-gradient-to-br from-primary/50 to-transparent">
<div className="bg-card-dark p-14 rounded-2xl h-full flex flex-col">
<div className="text-golden flex gap-1 mb-10">
...
<p className="text-slate-300 italic mb-12 leading-relaxed text-xl">"CYST APEX completely overhauled our lead gen system. Within 3 months, our cost per lead dropped by 45% while volume tripled."</p>
<div className="mt-auto flex items-center gap-5">
<div className="w-14 h-14 rounded-full bg-slate-800 border-2 border-primary/20"></div>
<div>
...
<p className="text-slate-300 italic mb-12 leading-relaxed text-xl">"Their web creation team is world-class. Our site speed and mobile conversion rates are now at an all-time high."</p>
<div className="mt-auto flex items-center gap-5">
<div className="w-14 h-14 rounded-full bg-slate-800 border-2 border-sea-blue/20"></div>
<div>
...
<p className="text-slate-300 italic mb-12 leading-relaxed text-xl">"The ROI we've seen on our social ad spend has been staggering. CYST APEX knows exactly where the attention is."</p>
<div className="mt-auto flex items-center gap-5">
<div className="w-14 h-14 rounded-full bg-slate-800 border-2 border-sea-green/20"></div>
<div>
