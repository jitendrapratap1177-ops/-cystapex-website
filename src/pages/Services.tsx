    ...
    <>
      ...
      <header className="relative pt-40 lg:pt-48 pb-20 lg:pb-32 px-6 lg:px-8 overflow-hidden" style={{
        ...
        <div className="max-w-[1400px] mx-auto relative z-10 text-center">
          ...
          <h1 className="text-4xl md:text-7xl lg:text-[100px] font-extrabold leading-[1] lg:leading-[0.9] tracking-tighter text-white mb-10 lg:mb-12">
            The Blueprint for<br className="hidden md:block" />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7c3bed] to-[#1E90D4]">Digital Dominance</span>
          </h1>
          <p className="max-w-2xl mx-auto text-lg lg:text-xl text-slate-400 leading-relaxed font-medium">
      ...
      <section className="py-24 lg:py-40 px-6 lg:px-8">
        <div className="max-w-[1400px] mx-auto grid md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="group relative p-1 rounded-[2.5rem] bg-gradient-to-br from-[#1E90D4]/20 to-transparent hover:from-[#1E90D4]/40 transition-all duration-500">
            <div className="bg-[#0A1628] rounded-[2.3rem] p-10 lg:p-12 bg-white/[0.03] backdrop-blur-xl border border-white/10 h-full flex flex-col">
      ...
      <section className="py-32 lg:py-48 px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto relative z-10 text-center">
          <h2 className="text-4xl md:text-7xl lg:text-[84px] font-extrabold text-white mb-10 leading-[1.1] lg:leading-[1] tracking-tighter">Ready to engineer your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#7c3bed] to-[#1E90D4]">dominance?</span></h2>
