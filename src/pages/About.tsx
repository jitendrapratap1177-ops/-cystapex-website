    ...
    <>
      ...
      <header className="relative pt-48 pb-32 px-8 overflow-hidden" style={{
        ...
        <div className="max-w-[1400px] mx-auto relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-[110px] font-extrabold leading-[0.9] tracking-tighter text-white mb-12">
            <span className="text-transparent bg-clip-text" style={{ background: 'linear-gradient(135deg, #fff 0%, #7c3bed 50%, #1E90D4 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>The Minds Behind</span> <br />
            <span className="text-white">The Growth.</span>
          </h1>
          <div className="flex justify-center gap-4 items-center">
            <div className="w-24 h-px bg-gradient-to-r from-transparent to-[#7c3bed]"></div>
            <div className="w-3 h-3 rounded-full bg-[#7c3bed] shadow-[0_0_15px_#7c3bed]"></div>
            <div className="w-24 h-px bg-gradient-to-l from-transparent to-[#7c3bed]"></div>
          </div>
        </div>
      ...
      {/* Mission & Core Values */}
      <section className="py-40 px-8 border-y border-white/5 relative">
        <div className="max-w-[1400px] mx-auto grid lg:grid-cols-2 gap-32 relative z-10">
          <div className="space-y-12">
            <div className="space-y-6">
              <h2 className="text-5xl font-extrabold text-white tracking-tight">Our Mission</h2>
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              <h2 className="text-5xl font-extrabold text-white tracking-tight">Core Values</h2>
      ...
      <section className="py-40 px-8 relative overflow-hidden bg-[#020408]">
        <div className="max-w-[1400px] mx-auto text-center relative z-10">
          <h2 className="text-sm font-black text-slate-500 uppercase tracking-[0.5em] mb-20">The Impact in Real-Time</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="p-10 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 relative overflow-hidden group">
              ...
              <div className="text-6xl font-black text-white tracking-tighter mb-4">$140M+</div>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-6">Revenue Generated</p>
            ...
            <div className="p-10 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 relative overflow-hidden group">
              ...
              <div className="text-6xl font-black text-white tracking-tighter mb-4">8.4x</div>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-6">Avg. ROAS Achieved</p>
              <div className="text-[#10B981] text-sm font-bold flex items-center justify-center gap-1">
            ...
            <div className="p-10 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 relative overflow-hidden group">
              ...
              <div className="text-6xl font-black text-white tracking-tighter mb-4">12M+</div>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-6">Qualified Leads</p>
              <div className="text-[#10B981] text-sm font-bold flex items-center justify-center gap-1">
            ...
            <div className="p-10 rounded-3xl bg-white/[0.03] backdrop-blur-xl border border-white/10 relative overflow-hidden group">
              ...
              <div className="text-6xl font-black text-white tracking-tighter mb-4">450%</div>
              <p className="text-slate-500 font-bold uppercase tracking-widest text-xs mb-6">YoY Client Growth</p>
              <div className="text-[#10B981] text-sm font-bold flex items-center justify-center gap-1">
      ...
      {/* The Founding Elite */}
      <section className="py-40 px-8 bg-[#05080F]">
        <div className="max-w-[1400px] mx-auto">
          <div className="text-center mb-24">
            <span className="text-[#7c3bed] font-black uppercase tracking-[0.4em] text-xs mb-6 inline-block">The Founding Elite</span>
            <h2 className="text-6xl font-extrabold text-white mb-8 tracking-tighter">Architects of Domination</h2>
            <p className="text-slate-400 text-xl leading-relaxed max-w-2xl mx-auto">The core trinity driving exponential results through technology, sales, and client mastery.</p>
          </div>
