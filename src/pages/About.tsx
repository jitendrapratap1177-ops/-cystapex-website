        ...
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="group relative p-1 rounded-[2.5rem] bg-gradient-to-br from-[#10B981]/20 to-transparent hover:from-[#10B981]/40 transition-all duration-500">
              <div className="bg-[#0A1628] rounded-[2.3rem] overflow-visible bg-white/[0.03] backdrop-blur-xl border border-white/10 h-full flex flex-col">
                <div className="min-h-[480px] lg:aspect-[4/5] relative m-4 rounded-[1.8rem] bg-white/5 border border-white/5 flex flex-col justify-center px-6 lg:px-8">
                  ...
                  <Link to="/about/aniket-singh" className="mt-auto group/link flex items-center gap-2 text-xs font-black text-[#10B981] tracking-[0.2em] hover:opacity-80 transition-all cursor-pointer py-2">
            ...
            <div className="group relative p-1 rounded-[2.5rem] bg-gradient-to-br from-[#1E90D4]/20 to-transparent hover:from-[#1E90D4]/40 transition-all duration-500">
              <div className="bg-[#0A1628] rounded-[2.3rem] overflow-visible bg-white/[0.03] backdrop-blur-xl border border-white/10 h-full flex flex-col">
                <div className="min-h-[480px] lg:aspect-[4/5] relative m-4 rounded-[1.8rem] bg-white/5 border border-white/5 flex flex-col justify-center px-6 lg:px-8">
                  ...
                  <Link to="/about/shantanu-singh" className="mt-auto group/link flex items-center gap-2 text-xs font-black text-[#1E90D4] tracking-[0.2em] hover:opacity-80 transition-all cursor-pointer py-2">
                    LEARN MORE <span className="material-symbols-outlined text-lg transition-transform group-hover/link:translate-x-1">arrow_right_alt</span>
                  </Link>
            ...
            <div className="group relative p-1 rounded-[2.5rem] bg-gradient-to-br from-[#7c3bed]/20 to-transparent hover:from-[#7c3bed]/40 transition-all duration-500">
              <div className="bg-[#0A1628] rounded-[2.3rem] overflow-visible bg-white/[0.03] backdrop-blur-xl border border-white/10 h-full flex flex-col">
                <div className="min-h-[480px] lg:aspect-[4/5] relative m-4 rounded-[1.8rem] bg-white/5 border border-white/5 flex flex-col justify-center px-6 lg:px-8">
                  ...
                  <Link to="/about/akhand-pratap-singh" className="mt-auto group/link flex items-center gap-2 text-xs font-black text-[#7c3bed] tracking-[0.2em] hover:opacity-80 transition-all cursor-pointer py-2">
                    LEARN MORE <span className="material-symbols-outlined text-lg transition-transform group-hover/link:translate-x-1">arrow_right_alt</span>
                  </Link>
