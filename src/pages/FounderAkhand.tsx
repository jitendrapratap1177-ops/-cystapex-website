    ...
    <>
      ...
      <header className="relative pt-48 pb-32 px-8 overflow-hidden" style={{
        ...
        <div className="max-w-[1400px] mx-auto relative z-10 text-center">
          ...
          <h1 className="text-5xl md:text-[120px] font-extrabold leading-[1.1] md:leading-[0.85] tracking-tighter text-white mb-12">
            AKHAND<br className="md:hidden" />
            PRATAP<br className="md:hidden" />
